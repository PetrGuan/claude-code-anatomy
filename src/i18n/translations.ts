...
const translations = {
  ...
  games: {
    hubTitle: { en: "Pixel Mini-Games", zh: "像素小游戏" },
    ...
    pg: {
      ...
      collectHint: { en: "Collect all context items!", zh: "收集所有上下文物品！" },
      tokenHint: { en: "Catch the streaming tokens!", zh: "接住流式 token！" },
      sortHint: { en: "Read-only → Parallel, Write → Serial!", zh: "只读 → 并行，写入 → 串行！" },
      gateHint: { en: "Walk through the correct gate!", zh: "走向正确的门！" },
      carrying: { en: "Carrying", zh: "携带中" },
      tokens: { en: "Tokens", zh: "Token" },
      sorted: { en: "Sorted", zh: "已分拣" },
      commands: { en: "Commands", zh: "命令" },
      parallel: { en: "Parallel", zh: "并行" },
      serial: { en: "Serial", zh: "串行" },
      allowGate: { en: "ALLOW", zh: "允许" },
      denyGate: { en: "DENY", zh: "拒绝" },
      askGate: { en: "ASK", zh: "询问" },
      inventory: { en: "Context Bag", zh: "上下文背包" },
      correctSort: { en: "Correct!", zh: "正确！" },
      ...
      room2Intro: { en: "Your packed message has been sent to the Claude API. Claude's response streams back word by word — catch the tokens to assemble the reply!", zh: "你打包好的消息已发送到 Claude API。Claude 的响应逐词流式返回 — 接住 token 来组装回复！" },
      ...
      tokenProgress: { en: "Tokens caught! Each one is a piece of Claude's streaming response.", zh: "接住了 token！每一个都是 Claude 流式响应的一部分。" }, // fallback; overridden by word-by-word narrative
      ...
      toolRead: { en: "Picked up Read — reads file contents without changing anything. Which lane?", zh: "拿起 Read — 读取文件内容，不做任何修改。放哪个轨道？" },
      toolGlob: { en: "Picked up Glob — finds files by name pattern. It only looks, never touches. Which lane?", zh: "拿起 Glob — 按文件名模式查找文件。只看不碰。放哪个轨道？" },
      toolGrep: { en: "Picked up Grep — searches inside files with regex. Just reading, nothing changes. Which lane?", zh: "拿起 Grep — 用正则搜索文件内容。只是阅读，什么都不改。放哪个轨道？" },
      toolEdit: { en: "Picked up Edit — finds text in a file and replaces it with new text. Think carefully! Which lane?", zh: "拿起 Edit — 在文件中查找文本并替换为新文本。想清楚！放哪个轨道？" },
      toolWrite: { en: "Picked up Write — creates a new file or overwrites an existing one. What kind of operation is this? Which lane?", zh: "拿起 Write — 创建新文件或覆盖现有文件。这是什么类型的操作？放哪个轨道？" },
      toolBash: { en: "Picked up Bash — executes shell commands that can do anything to the system. Which lane?", zh: "拿起 Bash — 执行 Shell 命令，可以对系统做任何事。放哪个轨道？" },
      // Sort messages
    ...
    ts: {
      ...
      desc: { en: "A Claude Code-themed Tetris — sort read and write tools with special rules!", zh: "Claude Code 主题的俄罗斯方块 — 用特殊规则分拣读写工具！" },
      score: { en: "Score", zh: "分数" },
      level: { en: "Level", zh: "等级" },
      linesCleared: { en: "Lines", zh: "行数" },
      combo: { en: "Combo", zh: "连击" },
      next: { en: "Next", zh: "下一个" },
      start: { en: "Start Game", zh: "开始游戏" },
      gameOver: { en: "Game Over", zh: "游戏结束" },
      playAgain: { en: "Play Again", zh: "再来一次" },
      parallelClear: { en: "PARALLEL CLEAR!", zh: "并行消除！" },
      serialClear: { en: "Serial clearing...", zh: "串行消除中..." },
      denied: { en: "DENIED! +50", zh: "已拒绝！+50" },
      dangerLanded: { en: "DANGER! Explosion!", zh: "危险！爆炸！" },
      compacting: { en: "COMPACTING...", zh: "压缩中..." },
      agentDeployed: { en: "Agent deployed!", zh: "Agent 已部署！" },
      agentReady: { en: "Agent Ready (A)", zh: "Agent 就绪 (A)" },
      noAgent: { en: "Agent charging...", zh: "Agent 充能中..." },
      slowMode: { en: "SLOW MODE", zh: "减速模式" },
      clearColumn: { en: "COLUMN CLEARED!", zh: "整列清除！" },
      readOnly: { en: "READ-ONLY MODE!", zh: "只读模式！" },
      controls: { en: "← → Move · ↑ Rotate · ↓ Drop · Space Hard Drop · X Deny · A Agent", zh: "← → 移动 · ↑ 旋转 · ↓ 下落 · 空格 硬降 · X 拒绝 · A Agent" },
    },
    qj: {

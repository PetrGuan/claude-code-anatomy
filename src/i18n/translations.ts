...
const translations = {
  ...
  games: {
    ...
    pg: {
      ...
      wrong: { en: "Wrong!", zh: "错误！" },
      realAnswer: { en: "Real system would:", zh: "真实系统会：" },
      score: { en: "Score", zh: "分数" },
      streak: { en: "Streak", zh: "连击" },
      timeLeft: { en: "Time", zh: "时间" },
      round: { en: "Round", zh: "第几轮" },
      ...
      rankRookie: { en: "Security Rookie", zh: "安全菜鸟" },
      rankGuard: { en: "Security Guard", zh: "安全守卫" },
      rankExpert: { en: "Security Expert", zh: "安全专家" },
      rankGuardian: { en: "Guardian", zh: "终极守护者" },
      howItWorks: { en: "How the real system works:", zh: "真实系统的工作方式：" },
    },
    ts: {
